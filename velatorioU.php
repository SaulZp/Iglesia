...
<html>
    ...
    <body>
        ...
        <section id="velacion" class="description_content">
            <div  class="velacion background_content">
                <h1>VELATORIO</h1>
...
Este servicio deberá solicitarse y coordinarse en la Secretaría Parroquial.</p>
                </div>
