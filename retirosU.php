...
<html>
    ...
    <body>
        ...
        <section id="retiros" class="description_content">
            <div  class="retiros background_content">
                <h1>RETIROS VOCACIONALES</h1>

            </div>
            <div class="text-content container"> 
                <div class="col-md-6">
                    
                    <p class="desc-text">Los retiros vocacionales son la inclinación o interés que sentimos para dedicarnos hacia una forma de vida o trabajo, estas jornadas nos ayudan a trazar nuestro plan de vida, profundizar nuestro llamado y conocer la voluntad de dios, nos permiten también clarificar que esperan los demás de nosotros y sobre todo que esperamos de nosotros mismos. De hecho la palabra vocación significa “llamado”.
</p>
                </div>
