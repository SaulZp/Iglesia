                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">Editar un evento</h4> </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php
                                ...
                                $query = "SELECT *FROM proximosEventos WHERE id_proximoEvento = $id_evento";
                                $result = mysqli_query($link,$query);
                                $row = $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
                            ?>

                            <form action="editarProximoxEvento.php?id_evento=<?php echo "$id_evento" ?>" method="POST" enctype="multipart/form-data">
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1">Nombre del evento</span>
                                    <input type="text" name="nombre" class="form-control" placeholder="Nombre" aria-describedby="basic-addon1" maxlength="30" value="<?php echo($row['nombreEvento']) ?>" required>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Descripción</label>
                                    <textarea class="form-control" rows="3" name="descripcion" required><?php echo($row['descripcion'])?></textarea>
                                </div>
                                <div class="form-group">
                                    
                                    <label for="datepicker">Fecha<br></label>
                                    <input type="date" id="datepicker" name="fecha" value="<?php echo($row['fecha']) ?>" required>    
                                </div>
                                <br>
                                <div class="custom-file">
                                    <label class="custom-file-label" for="customFile">Seleccionar imagen</label>
                                    <input type="file" class="custom-file-input" id="customFile" accept="image/*" name="imagen" value="img">
                                </div>
                                <br>
