            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="errorAgregarEvento.php" method="POST" enctype="multipart/form-data">
                        ...
                        if (isset($_POST['enviar'])) {
                            ...
                            if ((isset($imagen)) && ($uploadOk == 0)) {
                                echo "Error al agregar evento";
                            }else if (($imagen) && ($uploadOk ==1))) {
