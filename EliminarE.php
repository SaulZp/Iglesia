        ...
        <div class="container-fluid text-reservacion">
		 ...
		 <div class="container-fluid text-reservacion2">
			 ...
			 <div class="col-md-6 col-md-offset-3 text-center">
            	<h1  style="color:#000; font-weight:lighter;"> Mis eventos <br><br></h1>
          		<?php
						$nom=$_SESSION['id_us'];
				...
				?>
                <h2  style="color:#000; font-weight:lighter;"><br><br>Escriba el numero de reservacion del evento a eliminar<br><br></h2>
                ...
                <?php
					if(isset($_POST['enviar'])){
						...
						$link=mysqli_connect("localhost","root","");
						mysqli_select_db($link,"iglesia");
						$result=mysqli_query($link,"select id_reserva,id_evento,fecha from reservaciones where id_usuario='$usP'");
						
						
						if($row=mysqli_fetch_array($result)){
								
							
								$result2=mysqli_query($link,"select *from reservaciones where (id_usuario='$usP') and (id_reserva='$idE2')");
							...
							echo "<h2 style='color:red;'>No puede eliminar si aun no tiene ningun evento</h2>";
						}
					}
