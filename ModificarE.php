        ...
        <div class="container-fluid text-reservacion">
		 ...
		 <div class="container-fluid text-reservacion2">
			 ...
			 <div class="col-md-6 col-md-offset-3 text-center">
				...
				?>
                <h2  style="color:#000; font-weight:lighter;"> <br><br>Escriba el numero de reservacion del evento a modificar<br><br></h2>
                <form method="post" action="formularioE.php">
  					<input type="text" name="cajat"/>
					<br>
					<h2 style="color:#000; font-weight:lighter;">Fecha de evento:</h2><br> 
					<input type="date" name="fecha" value= "<?php echo date("Y-m-d");?>"/><br>
                     
                    <h2 style="color:#000; font-weight:lighter;">Hora del evento</h2><br>
